<template>
    <transition enter-active-class="animated fadeInLeft">
        <div class="form-wrap">
            <div class="search-wrap">
                <el-form :inline="true">
                    <el-form-item :label="$t('device')">
                        <el-radio label="PLOT_SELLER" v-model="params.statType">{{ $t('plotMachine') }}</el-radio>
                        <!-- <el-radio label="PRINT_SELLER" v-model="params.statType">{{ $t('printer') }}</el-radio> -->
                    </el-form-item>
            ...
            <h3>{{ $t('mechantPrintNumber') }}Top50</h3>
            <el-row>
                <el-col :span="16">
            ...
            <!-- <h3>{{ $t('mechantPrintList') }}</h3> -->
            <el-table :data="list">
                <el-table-column :label="$t('mechantId')" prop="statObjectUid"></el-table-column>
                <el-table-column :label="$t('mechantName')" prop="statObjectName"></el-table-column>
