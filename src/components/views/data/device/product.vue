<template>
    <transition enter-active-class="animated fadeInLeft">
        <div class="form-wrap">
            <div class="search-wrap">
                <el-form :inline="true">
                    <el-form-item :label="$t('device')">
                        <el-radio label="PLOT_PRODUCT" v-model="params.statType">{{ $t('plotMachine') }}</el-radio>
                        <!-- <el-radio label="PRINT_PRODUCT" v-model="params.statType">{{ $t('printer') }}</el-radio> -->
                    </el-form-item>
            ...
            <h3>{{ $t('productPrintNumber') }}Top50</h3>
            <el-row>
                <el-col :span="16">
            ...
            <!-- <h3>{{ $t('productPrintList') }}</h3> -->
            <el-table :data="list">
                <el-table-column :label="$t('productId')" prop="statObjectUid"></el-table-column>
                <!-- <el-table-column label="销售商"></el-table-column> -->
                <!-- <el-table-column label="商户"></el-table-column> -->
                <!-- <el-table-column label="设备SN码"></el-table-column> -->
                <el-table-column :label="$t('productName')" prop="statObjectName"></el-table-column>
                <el-table-column :label="$t('quantity')" prop="statValue"></el-table-column>
            </el-table>
            <!-- 分页组件 -->
            <pager
                :total="statTotal"
...
export default {
    name: 'Product',
    created () {
        this.fetchData(1, this.statSize)
    },
    data () {
        return {
            statPage: 1,
            ...
            chartData: {
                columns: ['statObjectName', 'statValue'],
                rows: []
            },
            searchCondition: 'all',
            params: {
                statType: 'PLOT_PRODUCT',
