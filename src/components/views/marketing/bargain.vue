    ...
    <transition enter-active-class="animated fadeInLeft">
        <div class="disribution-list">
            <div class="search-wrap">
                <el-button type="text" @click="addBargain">+新增砍价活动</el-button>
            </div>
            <!-- table表格 -->
            ...
            <el-dialog :title="dialogTitle" :visible.sync="addDialog">
                <el-form label-width="100px">
                    ...
                    <el-form-item label="是否包邮">
                        <el-checkbox :true-label="1" :false-label="0" v-model="form.exceiptShipfee">包邮</el-checkbox>
                    </el-form-item>
                    <el-form-item label="砍价人数">
                        <el-row>
                            <el-col style="width: 40px">需要</el-col>
                            <el-col style="width: 80px">
                                <el-input v-model.number="form.person"></el-input>
                            </el-col>
...
export default {
    ...
    methods: {
        ...
        getBargainDetail (uid) {
            this.$axios.post(promotion.barginDetail, {
                ...
                if (res.data.state) {
                    ...
                    this.form.exceiptShipfee = res.data.data.exceiptShipfee
        ...
        addBargain () {
            this.flag = 'add'
            this.dialogTitle = '新增砍价'
            this.addDialog = true
            this.form.name = ''
            this.form.startTime = ''
            this.form.endTime = ''
            this.form.exceiptShipfee = 0
            this.form.person = 0
            this.form.uid = 0
        ...
        fetchData (pageNum, pageSize) {
            ...
            this.loading = true
            this.$axios.post(promotion.bargainList, {
                lang: localStorage.lang,
        ...
        deleteResult (item) {
            ...
            let index
            if (item.skuUid) {
                index = this.result.findIndex(el => el.skuUid === item.skuUid )
            } else {
                index = this.result.findIndex(el => el.productUid === item.productUid )
            }
            if (item.uid === 0) {
        ...
        save () {
            ...
            let url = ''
            if (this.flag === 'add') {
                url = promotion.bargainAdd
            } else {
                url = promotion.bargainEdit
            }
