    ...
    <transition enter-active-class="animated fadeInLeft">
        <div class="disribution-list">
            <div class="search-wrap">
                <el-button type="text" @click="addBargain">+新增积分兑换</el-button>
            </div>
            <!-- table表格 -->
            <div class="table-wrap" ref="myTable" v-loading="loading" :element-loading-text="$t('loadingText')">
                <el-table
                    ...
                    <el-table-column
                        ...
                        label="操作">
                        <template slot-scope="scope">
                            <el-button type="primary" size="small" icon="el-icon-edit" @click="editBargain(scope.row)"></el-button>
                            <el-button type="danger" size="small" icon="el-icon-delete" @click="delBargain(scope.row.uid)"></el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </div>
