            ...
            <el-scrollbar wrap-class="scroll-wrap-panel" view-class="view-box" :native="false">
                <div class="form-wrap">
                    <el-form label-position="right" label-width="80px" :model="form" :rules="rules" ref="ruleForm">
                        ...
                        <el-row>
                            <el-col :span="8" v-if="$route.params.type === 'PLOT'" class="form-col">
                                <el-form-item :label="$t('file')">
                                    <!-- <span class="download-file">{{ $t('downloadFile') }}</span> -->
                                    <el-upload
                                        action=""
                                        :auto-upload="false"
                                        :file-list="fileList"
                        ...
                        <!-- 成品商品才有sku，spu -->
                        <el-row v-if="$route.params.type === 'FIXED'">
                            <el-col class="form-col" :span="8" v-for="(spu, index) in form.spuList" :key="index">
                                <el-form-item
                ...
                <div class="sku-form-wrap" v-if="form.uid && $route.params.type === 'FIXED'">
                    <h4>设置sku属性</h4>
                    ...
                    <div class="sku-list" v-if="reloadCom">
                        <div class="list-row">
                        ...
                        <div class="list-row vertical" v-for="(item, index) in skuForm.skuItems" :key="item.uid">
                            ...
                            <div class="list-col">
                                <el-input v-model.number="item.stock"></el-input>
                            </div>
                            <div class="list-col">
                            ...
                            <div class="list-col" v-for="(sku, index) in item.result" :key="index">
                                {{ sku.text || sku.cntext }}
                            </div>
                            <div class="list-col">
                ...
                <div class="save-groups" v-if="form.uid && $route.params.type === 'FIXED'">
                    <el-button
                        type="primary"
...
export default {
    ...
    methods: {
        ...
        // 保存商品基本信息
        saveProductInfo () {
            var subUrl = product.saveProduct
            var categoryUid = this.form.categoryUid
            // 保存后编辑商品基本信息
            if (this.form.uid) {
                subUrl = product.updateProduct
            } else {
                categoryUid = this.form.categoryUid[this.form.categoryUid.length - 1]
            }
            ...
            this.$axios.post(subUrl, {
                ...
                if (res.data.state) {
                    ...
                    if (this.$route.params.type !== 'FIXED') {
                        this.$router.push({
                            path: '/product?type=' + this.$route.params.type
                        })
                    }
                    // 成功之后返回商品uid
                    this.form.uid = res.data.data.uid
