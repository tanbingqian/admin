    ...
    Panel.prototype = {
        ...
        show: function show() {
            ...
            var $tabContentContainer = $(
                '<div class="w-e-panel-tab-content"></div>'
            )
        ...
        _createPanel: function _createPanel() {
            ...
            emotions.forEach(function(emotData) {
                ...
                tabConfig.push({
                    ...
                    tpl:
                        '<div class="w-e-emoticon-container">' +
                        faceHtml +
                        "</div>",
                    events: [
                        {
    ...
    Text.prototype = {
        ...
        _enterKeyHandle: function _enterKeyHandle() {
            ...
            function codeHandle(e) {
                ...
                if (
                    editor.selection.getRange().startOffset + 1 ===
                    codeLength
                ) {
...
*/
    ...
    API.prototype = {
        ...
        // 根据 $Elem 设置选区
        createRangeByElem: function createRangeByElem(
            $elem,
            toStart,
            isContent
        ) {
